...
export default async function Header() {
    ...
    return (
        <section className="h-full flex bg-slate-950 text-white">
            ...
            {credentialsToken || oauthSession && <div className="flex items-center my-4 mr-4 border-2 border-red-500 rounded-md hover:bg-slate-900">
                <Link className="px-4" href={"/profile"}>Profile</Link>
            </div>}
            <div className="flex items-center my-4 mr-4 border-2 border-red-500 rounded-md hover:bg-slate-900">
